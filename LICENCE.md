...
The Mojaloop DFSP Portal files are made available by Bangladeshi Software Ltd.
...
This project implements the **Mojaloop DFSP Portal** — the web interface for
Digital Financial Service Providers to manage their connection to the Mojaloop
Switch. It provides tools for certificate management, endpoint configuration,
transaction monitoring, and operational oversight.

**Key Features:**
- DFSP Connection Management
